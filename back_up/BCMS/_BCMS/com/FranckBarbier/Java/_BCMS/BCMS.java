...
// Error:
    ...
    public static void main(String args[])
    {
        try
        {
             ...
             * 'route_for_police_vehicles' that is internally re-sent, arrives
             * before what follows:
             */
            ...
            /**
             * Bug due to PlantUML modeling style. One must await so that
             * 'completion' that is internally sent, arrives before what
             * follows:
             */
            ...
            bCMS.close();
            /**
             * End of state machine is delayed so that events internally sent
